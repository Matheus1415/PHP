  ...
  <div class="container py-4">
    <header class="pb-3 mb-4 border-bottom">
      <a href="/" class="d-flex align-items-center text-dark text-decoration-none">
        ...
        <span class="fs-4">Titulo do templet</span>
      </a>
    </header>
    ...
    <div class="p-5 mb-4 bg-light rounded-3">
      <div class="container-fluid py-5">
        ...
        <button class="btn btn-primary btn-lg" type="button">Acessar conteúdo</button>
      </div>
    </div>
      ...
      <div class="col-md-6">
        <div class="h-100 p-5 bg-light border rounded-3">
            ...
            if(isset ($_POST['botao'])){//isset verifica se a ação
                ...
                }else if(($media > 7.9) && ($media=10)){        echo '<div class="alert alert-success" role="alert"> O aluno '.$aluno.' passou direto  :) com a nota '.$media.'</div>';
                }
                }
            ?><!--fecha PHP-->
